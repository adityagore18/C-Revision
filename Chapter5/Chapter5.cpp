...
class A{
    ...
    static void getCount(void){ ///static member function  ,it only used static data member
        cout<<"count : ";
        cout<<count<<endl;
    }
};

int A::count; // definition of static data member (it is necessary define outside the class because they are stored separately )
